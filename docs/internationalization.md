...
- Experience rows in the Background tab use [`src/locales/en/experience.json`](../src/locales/en/experience.json), [`src/locales/de/experience.json`](../src/locales/de/experience.json), and [`src/locales/cs/experience.json`](../src/locales/cs/experience.json), merged in [`src/lib/data/experience.js`](../src/lib/data/experience.js) via [`src/lib/data/experienceLocales.js`](../src/lib/data/experienceLocales.js) (`getExperienceCopy` shares the same locale normalization as projects).
