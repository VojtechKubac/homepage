...
\name{Vojtěch}{Kubáč}
\title{SW engineer · C++, web full-stack, applied ML}
% \address{Rokycanova 2152}{53002, Pardubice}{Czech Republic}
...
\cventry{2024--today}{Software engineer}{Ententee}{}{}{%
  Full-stack product delivery across healthcare and robotics engagements,
  developed alongside my role at CFD Support. Stack spans Python (Django, FastAPI),
  Java / Spring Boot, React / TypeScript, PostgreSQL, with ROS / Gazebo
  and C\texttt{++} on the UAV side.
  \begin{itemize}%
    ...
    \item \textbf{THK UAV ·} greenfield stack: perception, mission autonomy, GPS-denied navigation.
  \end{itemize}}
...
\section{Skills}
\cvitem{Programming}{C\texttt{++} (C\texttt{++}23), Python, TypeScript, Java, Bash}
